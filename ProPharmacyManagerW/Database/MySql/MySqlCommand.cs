...
namespace ProPharmacyManagerW.Database
{
    public class MySqlCommand
    {
        ...
        private Dictionary<byte, decimal> decimalValues;
        ...
        public MySqlCommand Set(string column, decimal value)
        {
            if (Type == MySqlCommandType.UPDATE)
            {
                if (Comma())
        ...
        /// <summary>
        /// add decimal value to a column
        /// </summary>
        /// <param name="field">column name</param>
        /// <param name="value">decimal value</param>
        /// <returns></returns>
        public MySqlCommand Insert(string field, decimal value)
        {
            Fields.Add(lastpair, field);
            decimalValues.Add(lastpair, value);
            lastpair++;
            return this;
        }
        /// <summary> 
        ...
        /// <summary> 
        /// compare decimal between two values column value = new value
        /// </summary> 
        /// <param name="column">column name</param>
        /// <param name="value">decimal value</param>
        public MySqlCommand Where(string column, decimal value)
        {
            _command = _command.Append("WHERE `" + column + "` = '" + value + "'");
            return this;
        }
        /// <summary> 
        /// compare decimal between two values column value > new value true else false
        /// </summary> 
        /// <param name="column">column name</param>
        /// <param name="value">decimal value</param>
        /// <param name="greater">True if greater</param>
        public MySqlCommand Where(string column, decimal value, bool greater)
        {
            if (greater)
                _command = _command.Append("WHERE `" + column + "` > '" + value + "'");
            else
        ...
        public MySqlCommand And(string column, decimal value)
        {
            _command = _command.Append(" AND `" + column + "` = '" + value + "'");
            return this;
        }
        public MySqlCommand And(string column, decimal value, bool greater)
        {
            if (greater)
                _command = _command.Append("AND `" + column + "` > '" + value + "'");
            else
        ...
        #region Like
        /// <summary>
        ///  Get a similar word based on the same characters
        /// </summary>
        /// <param name="column">column name</param>
        /// <param name="value">string value</param>
        /// <returns></returns>
        public MySqlCommand WhereLike(string column, string value)
        {
            _command = _command.Append("WHERE " + column + " LIKE '%" + value + "%'");
            return this;
        }
        /// <summary>
        /// Get a similar word that start or end with the same character
        /// </summary>
        /// <param name="column">column name</param>
        /// <param name="value">string value</param>
        /// <param name="Firstlike"> to search for first letter if true else last letter</param>
        /// <returns></returns>
        public MySqlCommand WhereLike(string column, string value, bool Firstlike)
        {
            if (Firstlike)
                _command = _command.Append("WHERE " + column + " LIKE '%" + value + "'");
            else
        ...
        public int Execute()
        {
            if (Type == MySqlCommandType.INSERT)
            {
                ...
                for (x = 0; x < lastpair; x++)
                {
                    ...
                    else if (decimalValues.ContainsKey(x))
                    {
                        if (comma)
                            values += "'" + decimalValues[x] + "'" + ",";
                        else
                            values += "'" + decimalValues[x] + "'";
                    }
        ...
        public int Execute(MySql.Data.MySqlClient.MySqlConnection conn)
        {
            if (Type == MySqlCommandType.INSERT)
            {
                ...
                for (x = 0; x < lastpair; x++)
                {
                    ...
                    {
                        if (comma)
                            values += decimalValues[x].ToString()[x] + ",";
                        else
                            values += decimalValues[x].ToString();
                    }
                    else if (boolValues.ContainsKey(x))
                    {
                        if (comma)
